...
This script trains an IQL/CQL critic on trajectory data, then exports
...
def main():
    ...
    parser.add_argument("--algo", choices=["iql", "cql"], default="iql", help="Algorithm for critic training")
    ...
    parser.add_argument("--alpha", type=float, default=1.0, help="CQL conservative coefficient")
    ...
    for traj in store.iter_trajectories():
        for i, step in enumerate(traj.steps):
            ...
            if args.algo == "iql":
                ...
                advantage = q_value  # CQL Q-values as proxy for advantages
