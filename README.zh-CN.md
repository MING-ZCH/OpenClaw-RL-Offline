...
flowchart LR
  ...
  C --> D[IQL / CQL / AWAC / GRPO / ... 共 28 种轻量 offline baseline]
  D --> E[权重文件、诊断指标、回放统计]
...
| 比较离线算法 baseline | `offline-rl/scripts/train_offline.py` | 不进入完整 slime 栈也能比较 IQL / CQL / AWAC / GRPO / TD3+BC / EDAC / DT / CRR / RW-FT / OREO / SORL / ARPO / Retrospex / WebRL / GLIDER / ArCHer / BCQ / DPO / KTO / REBEL / DigiRL / DigiQ / IPO / CPO / SimPO / DMPO / ETO / VEM 共 28 种算法。 |
