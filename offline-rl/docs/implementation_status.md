...
| Offline algorithms | `IQL`, `CQL`, `AWAC`, and `OffPolicyGRPO` all have working training loops, metrics, and tests. | The repo contains executable offline RL baselines, not placeholder class shells. |
